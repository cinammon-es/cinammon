        ...
        <div class="services-container">
            <div class="services-box">
                ...
                <div class="banner-text">
                    <h1> </h1>
                    <p>...</p>
                    <a href=" /prices/prices.php#vps-freeplan" class="btn">contrata</a> <br> <br>
                </div>
            </div>
            <div class="services-box">
                ...
                <div class="banner-text">
                    <h1> </h1>
                    <p>...</p>
                    <a href=" /prices/prices.php#vps-basicplan" class="btn">contrata</a> <br> <br>
                </div>
            </div>
            <div class="services-box">
                ...
                <div class="banner-text">
                    <h1> </h1>
                    <p>...</p>
                    <a href=" /prices/prices.php#vps-premiumplan" class="btn">contrata</a> <br> <br>
                </div>
            </div>
            <div class="services-box">
                <i class="bx bx-server"></i>
                ...
                <div class="banner-text">
                    <h1> </h1>
                    <p>...</p>
                    <a href=" /prices/prices.php#vps-ultimateplan" class="btn">contrata</a> <br> <br>
                </div>
            </div>
        </div>
    </section>
