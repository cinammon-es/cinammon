...
<body>
    ...
    <section class="services" id="services">
        ...
        <h2 class="heading"><span>Cinammon Hosting</span> Discord Bots</h2>
        ...
        <div class="services-container">
            <div class="services-box">
                ...
                <div class="banner-text">
                    <h1> </h1>
                    <p>...</p>
                    <a href=" /prices/prices.php#discordbot-freeplan" class="btn">contrata</a> <br> <br>
                </div>
            </div>
            <div class="services-box">
                ...
                <div class="banner-text">
                    <h1> </h1>
                    <p>...</p>
                    <a href=" /prices/prices.php#discordbot-basicplan" class="btn">contrata</a> <br> <br>
                </div>
            </div>
            <div class="services-box">
                ...
                <div class="banner-text">
                    <h1> </h1>
                    <p>...</p>
                    <a href=" /prices/prices.php#discordbot-premiumplan" class="btn">contrata</a> <br> <br>
                </div>
            </div>
            <div class="services-box">
                <i class="bx bx-server"></i>
                ...
                <div class="banner-text">
                    <h1> </h1>
                    <p>...</p>
                    <a href=" /prices/prices.php#discordbot-ultimateplan" class="btn">contrata</a> <br> <br>
                </div>
            </div>
        </div>
    </section>
