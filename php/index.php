...
<body>
    ...
    <section class="services" id="services" aria-labelledby="services-title">
        ...
        <div class="services-container">
            ...
            <div class="services-box">
                ...
                <a href="/php/services/dedicatedservers.php" class="btn">Ver más</a>
            </div>
            <div class="services-box">
                <i class="bx bx-server"></i>
                <h3><span>VPS</span> Hosting</h3>
                <p>Con nuestras VPS podrás tener tu propio sistema para hostear lo que quieras.</p>
                <a href="/php/services/vpshosting.php" class="btn">Ver más</a>
            </div>
        </div>
    </section>
    ...
    <section class="signup" id="signup">
        ...
        <div class="signup-img">
            <img src="/images/main/hana_not-background.png" alt="Imagen de registro">
        </div>
    </section>

    <section class="signin" id="signin">
        <div class="signin-content">
            <h2 class="heading">Iniciar <span>Sesión</span></h2>
        ...
        <div class="signin-img">
            <img src="/images/main/hana_not-background.png" alt="Imagen de inicio de sesión">
        </div>
    </section>
-->
